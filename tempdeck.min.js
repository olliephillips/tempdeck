...
tempdeck.mqttSetup()})})},monitor:function(){tempdeck.monitorCount=0;tempdeck.onAlert=!1;setInterval(function(){tempdeck.curTemp=tempdeck.probe.getTemp().toFixed(2);0<tempdeck.monitorCount&&(console.log("Current temp is "+tempdeck.curTemp),!0===tempdeck.send&&(tempdeck.message={targetTemp:tempdeck.config.target,currentTemp:tempdeck.curTemp},tempdeck.mqtt.publish("tempdeck/espruino/"+tempdeck.config.serial,JSON.stringify(tempdeck.message))),tempdeck.variance=tempdeck.config.target-tempdeck.curTemp,
